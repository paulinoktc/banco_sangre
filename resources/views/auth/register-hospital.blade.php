...
@section('authorization')
    <main id="main">
        <div id="contenedor" class="container mt-4 mb-4 pb-4">
            ...
            <form class="form-horizontal" name="registro-donador" method="POST" action="{{route('register') }}">
                @csrf    
                <div class="row text-center mt-5 ps-4 pe-4">
                    <div class="col-12 col-md-6 text-start">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="" name="rfc" id="rfc" class="form-control mb-4" placeholder="Tu RFC...">
                        </div>
                        <div class="form-group">
                            <label for="certificado" class="control-label">Certificado</label>
                            <input type="file" value="" name="certificado" id="certificado" class="form-control mb-4">
                        </div>
                ...
                <div class="row ps-4 pe-4">
                        <div class="form-group col d-grid">
                            <button class="btn btn-primary mb-4 mt-4"  type="submit" >{{ __('Registrar') }}</button>
                        </div> 
                </div>
            </form>
        </div>
