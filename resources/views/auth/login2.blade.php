                ...
                <div class="col pt-2">
                    <form method="POST" action="{{route('login') }}">
                        ...
                        <div class="form-row ms-4 me-4">
                            ...
                            <div class="form-group col-6 col-md-12 mb-4">
                                <input id="text" class="block mt-1 w-full form-control"  name="ap_paterno"  required >
                                @if ($errors->has('email'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('email') }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-6 col-md-12 mb-4">
                                <input id="text" class="block mt-1 w-full form-control"  name="ap_materno" required>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('email') }}</strong>
                                    </span>
